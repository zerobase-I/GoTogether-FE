  ...
  <div className="container mx-auto my-8">
      ...
      <div className="grid gap-4">
        {data && data.length > 0 && data.map(room => (
          <Link to={`/chatroom/${room.chatRoomId}`} key={room.chatRoomId} className="bg-white p-4 rounded-md shadow-md hover:shadow-lg cursor-pointer transition duration-300 ease-in-out flex items-center justify-between">
